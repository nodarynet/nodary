...
| The matrix in front of the two people who need it. `model register` now offers the backends a node's silicon runs and recommends one; the **install wizard** takes that recommendation without asking, and a **buyer** choosing a card cannot read the table anywhere yet | [R6b](plans/R6b-the-silicon-matrix.md) |
