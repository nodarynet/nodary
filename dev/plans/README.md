...
| [R6b — Which backend runs on which silicon](R6b-the-silicon-matrix.md) | [R6](../tasks/R6-backends.md) | R6-16 – R6-19 | scoped: NVIDIA native, everything else Vulkan; the offer is unbuilt |
