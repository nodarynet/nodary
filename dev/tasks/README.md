...
| **[R2](R2-control-plane.md)** | Control plane | State has one owner | task | 0 of 45 |
| **[R3](R3-gateway.md)** | Gateway | Tokens and usage | deliverable | 8 of 25 |
| **[R4](R4-agent.md)** | Agent | Nodes run without an orchestrator | deliverable | 0 of 45 |
| **[R5](R5-install.md)** | Installation | One-command install — the goal is met | deliverable | **1 of 34** |
| **[R6](R6-backends.md)** | Backends | Pluggability is real, not theoretical | deliverable | 0 of 25 |
...
| **[R9](R9-evidence-remediation.md)** | Evidence and remediation | Records become a deliverable an assessor consumes | task | 0 of 21 |
...
late because [the MVP route](../plans/mvp.md) pulls part of it forward — the bundle's
format is the one thing in the product that cannot be changed after a customer holds one.
It cites the pivot rather than a specification until specs 13 and 14 exist.
