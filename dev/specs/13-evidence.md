...
| `remediation.jsonl` | What was known, decided, by whom, with what justification · [pivot §6](../plans/pivot-cmmc.md#6-flaw-remediation--spec-14-adr-0007). Undecided findings are in it too: a plan of action is mostly what nobody has got to yet |
