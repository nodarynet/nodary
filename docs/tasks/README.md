...
| **[R5](R5-install.md)** | Installation | One-command install — the goal is met | deliverable | 11 of 33 |
| **[R6](R6-backends.md)** | Backends | Pluggability is real, not theoretical | deliverable | 7 of 16 |
...
| **[R9](R9-evidence-remediation.md)** | Evidence and remediation | Records become a deliverable an assessor consumes | task | 3 of 20 |
