...
| **[R4](R4-agent.md)** | Agent | Nodes run without an orchestrator | deliverable | 0 of 44 |
| **[R5](R5-install.md)** | Installation | One-command install — the goal is met | deliverable | 2 of 33 |
