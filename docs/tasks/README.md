...
| **[R1](R1-core-audit-identity.md)** | Core, audit, identity | Accountability, before any rearchitecture | task | 12 of 36 |
| **[R2](R2-control-plane.md)** | Control plane | State has one owner | task | 42 |
