...
- [ ] **R3-14** Route round-robin across ready members, with health-driven membership changes honoured live · [05 §5](../specs/05-catalog.md#5-routes)
  - *partial:* `nodary gateway sync` renders the data plane from current routes and restarts it when the file changes, which is the manual form of this. Live membership is what stays open
