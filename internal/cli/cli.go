...
Available in this release:
  ...
  bundle               Offline install archives
                         create  Assemble one from the component cache
                         show    What is in a bundle, without extracting it
                         open    Verify it into this host's cache
