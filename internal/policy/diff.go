...
var fields = []field{
	...
	{"allow_derived_images", showBool(func(p Profile) bool { return p.AllowDerivedImages }), allowLoosens(func(p Profile) bool { return p.AllowDerivedImages }), enforced},
	{"require_pinned_derives", showBool(func(p Profile) bool { return p.RequirePinnedDerives }), requireLoosens(func(p Profile) bool { return p.RequirePinnedDerives }), enforced},
