...
it, so the profile can be read as a list of controls rather than a list of numbers. One of
its seventeen settings is marked today. Two more are **invariants** — `require_signed_artifacts`
